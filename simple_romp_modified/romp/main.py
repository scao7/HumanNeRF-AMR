...
def romp_settings(input_args=sys.argv[1:]):
    ...
    parser.add_argument('--show_items', type=str, default='mesh', help = 'The items to visualized, including mesh,pj2d,j3d,mesh_bird_view,mesh_side_view,center_conf,mesh_only. splited with ,')
